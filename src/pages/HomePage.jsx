                ...
                <div className="footer-content">
                    <div className="footer-info">
                        ...
                        <p className="footer-creator">
                            Created by <strong>Rohith Vijayan</strong>
                        </p>
                    </div>
                    <div className="footer-social">
                        <a href="https://github.com/rohithvijayan/KeralaNXT" aria-label="GitHub">
                            <span className="material-symbols-outlined">code</span>
                        </a>
                        <a href="https://www.linkedin.com/in/rohithvijayan/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="popup-content">
                                ...
                                <p>Where We Spend, Where We Gained-Everything At Once Place.</p>
